...
export default function Trending( ) {
    ...
    return (
        <div className="hidden lg:flex flex-col ml-7 mt-4">
            ...
            <div className="flex space-x-3 bg-white bg-opacity-10 w-[300px] h-[44px] p-0
            rounded-3xl">
                <SearchIcon className=" ml-3 w-6 text-gray-600" />
                <input
            ...
            <div className="w-[300px] h-[500px] bg-white bg-opacity-10 rounded-3xl
            mt-3">
